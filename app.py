...
# #load database
# sym_des = pd.read_csv("E:\Medical Recommendation System\dataset\symtoms_df.csv")
# precautions = pd.read_csv("E:\Medical Recommendation System\dataset\precautions_df.csv")
# workout = pd.read_csv("E:\Medical Recommendation System\dataset\workout_df.csv")
# description = pd.read_csv("E:\Medical Recommendation System\dataset\description.csv")
# medications = pd.read_csv("E:\Medical Recommendation System\dataset\medications.csv")
# diets = pd.read_csv("E:\Medical Recommendation System\dataset\diets.csv")


# #load model
# with open("E:\Medical Recommendation System\model.pkl", "rb") as model_file:
...
#     return diseases_list[int(round(prediction))]
...
#         return render_template('index.html',predicted_disease= predicted_disease, dis_desc = desc, dis_pre=my_pre, dis_die=die,dis_med = med,dis_wrkout = wrkout)
...
@app.route('/')
def index():
    return "Welcome to the Symptom Checker API"
...
def predict():
    ...
    desc, pre, med, die, wrkout = helper(predicted_disease)
    my_pre = [i for i in pre if pd.notna(i)]  # Filter out any NaN values
